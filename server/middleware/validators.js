...
exports.validateUserRegistration = [
  ...
  check("password")
    .isLength({ min: 6 })
    .withMessage("Password must atleast characters"),
];
...
exports.validateUserStreakItems = [
  check("recordedAt").notEmpty().withMessage("Date is required"),
  check("streakItems").notEmpty().withMessage("Streaks are required"),
];
